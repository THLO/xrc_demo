...
export const canisterId = process.env.XRC_DEMO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xrc_demo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xrc_demo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xrc_demo.did.js")._SERVICE>}
 */
export const xrc_demo = createActor(canisterId);
