...
import { idlFactory } from './xrc_demo_backend.did.js';
export { idlFactory } from './xrc_demo_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.XRC_DEMO_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xrc_demo_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xrc_demo_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xrc_demo_backend.did.js")._SERVICE>}
 */
export const xrc_demo_backend = createActor(canisterId);
