 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xrc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xrc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xrc.did.js")._SERVICE>}
 */
