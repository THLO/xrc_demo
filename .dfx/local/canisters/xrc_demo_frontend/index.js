...
import { idlFactory } from './xrc_demo_frontend.did.js';
export { idlFactory } from './xrc_demo_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.XRC_DEMO_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./xrc_demo_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the xrc_demo_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./xrc_demo_frontend.did.js")._SERVICE>}
 */
export const xrc_demo_frontend = createActor(canisterId);
